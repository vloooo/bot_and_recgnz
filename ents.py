...
serv_hist = '1 2 3 full part no missing'

serv_hist_kind = {'1': 'Full service history', 'full': 'Full service history',
                  '2': 'Part service history', 'part': 'Part service history',
...
cities = ['London', 'Birmingham', 'Leeds', 'Glasgow', 'Sheffield', 'Bradford', 'Liverpool', 'Edinburgh', 'Manchester',
          ...
          'Carmarthenshire', 'Bath & North East Somerset', 'Basildon', 'Bournemouth', 'Peterborough', 'Colchester',
          'North East Lincolnshire', 'Chelmsford', 'Brighton', 'South Tyneside', 'Charnwood', 'Aylesbury Vale',
          'Knowsley', 'North Lincolnshire', 'Huntingdonshire', 'Macclesfield', 'Blackpool', 'West Lothian', 'Newbury',
          'South Somerset', 'Dundee', 'Basingstoke & Deane', 'Harrogate', 'Dumfries & Galloway', 'Middlesbrough',
          'Flintshire', 'Rochester-upon-Medway', 'The Wrekin',  'Falkirk', 'Reading', 'Wokingham', 'North Ayrshire',
          'Windsor & Maidenhead', 'Maidstone', 'Redcar & Cleveland', 'Blackburn', 'Neath Port Talbot', 'Poole', 'Swale',
          'Wealden', 'Bedford',  'Lancaster', 'Newport', 'Canterbury', 'Preston', 'Dacorum', 'Cherwell', 'Mid Sussex',
          'Perth & Kinross', 'Thurrock', 'Tendring', 'Kings Lynn & West Norfolk', 'St Albans', 'Bridgend', 'Elmbridge',
          ...
          'Vale of Glamorgan', 'Reigate & Banstead', 'Chester', 'Mid Bedfordshire', 'Suffolk Coastal', 'Horsham',
          'Nuneaton & Bedworth', 'Gwynedd', 'Havant & Waterloo', 'Teignbridge', 'Cambridge', 'Vale Royal', 'Oxford',
          'Amber Valley', 'North Hertfordshire', 'South Ayrshire', 'Waverley', 'Broadland', 'Crewe & Nantwich',
